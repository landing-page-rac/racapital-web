...
const FooterMobile: React.FC = () => {
  const { data, isLoading, error } = useFooterDataCached();

  // Show loading state
  if (isLoading) {
    return (
      <footer className="bg-[#041E42] text-white py-12 px-4 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto relative z-10">
          ...
          <div className="space-y-4">
            ...
            <div className="text-xs text-white/60">
              RAC Capital Management. All rights reserved.
            </div>
          </div>
        </div>
      </footer>
