...
interface InsightDetailPageDesktopProps {
  insight: InsightData;
}

const InsightDetailPageDesktop: React.FC<InsightDetailPageDesktopProps> = ({ insight }) => {
  return (
...
export default InsightDetailPageDesktop;
