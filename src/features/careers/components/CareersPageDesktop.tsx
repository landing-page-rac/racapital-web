          ...
          >
            <div className="flex items-center justify-between">
              <div className="flex-1 flex gap-24">
                ...
                <motion.p
                  className="text-2xl lg:text-2xl text-white/90 leading-relaxed max-w-xl"
                ...
                >
                  <strong>Unlock your potential</strong> by collaborating with experts, driving innovation, and making an impact at every level.
                </motion.p>
              </div>
            </div>
          </motion.div>
